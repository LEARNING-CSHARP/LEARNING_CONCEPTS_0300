...
// می‌گویند Local Variable متغیرهایی که در داخل یک تابع تعریف می‌کنیم اصطلاحاً به آنها متغیر محلی یا
// می‌گویند Field متغیرهایی که در داخل کلاس تعریف می‌شوند اصطلاحاً به آنها
